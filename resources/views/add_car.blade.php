      ...
      <a href="{{ LaravelLocalization::getLocalizedURL('ar') }}">Arabic</a>
        ...
        <form action="{{route('cars.store')}}" method="POST" class="px-md-5" enctype="multipart/form-data">
          ...
          <div class="form-group mb-3 row">
            <label for="" class="form-label col-md-2 fw-bold text-md-end">{{__('cars.titlec')}}:</label>
            <div class="col-md-10">
              <input type="text" placeholder="{{__('cars.titlep')}}" class="form-control py-2" name="carTitle" value="{{old('carTitle')}}"/>
              @error('carTitle')
          ...
          <div class="form-group mb-3 row">
            ...
            <div class="col-md-10">
              <input type="text" step="0.1" placeholder="{{__('cars.pricep')}}" class="form-control py-2" name="price" value="{{old('price')}}"/>
              @error('price')
              <div class="alert alert-warning">{{$message}}</div>
              @enderror
            </div>
            ...
            <div class="col-md-10">
              <select name="category_id" id="" class="form-control py-2" >
                <option value="">{{__('cars.Categoryp')}}</option>
          ...
          <div class="form-group mb-3 row">
            ...
            <div class="col-md-10">
              <textarea placeholder="{{__('cars.Descriptionp')}}" name="description" id="" cols="30" rows="5" class="form-control py-2">{{old('description')}}</textarea>
              @error('description')
              <div class="alert alert-warning">{{$message}}</div>
              @enderror
            </div>
            <div class="form-group mb-3 row">
            <label for="" class="form-label col-md-2 fw-bold text-md-end"> {{__('cars.Image')}}:</label>
            <div class="col-md-10">
