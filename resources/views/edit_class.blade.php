      ...
      <div class="bg-light p-5 rounded">
        ...
        <form action="{{route('class.store')}}" method="POST" class="px-md-5">
          ...
          <div class="form-group mb-3 row">
            ...
            <div class="col-md-10">
              <input type="text" placeholder="BMW" class="form-control py-2" name="class_name" value="{{$class->class_name}}" />
            </div>
          </div>
          <div class="form-group mb-3 row">
          ...
          <div class="form-group mb-3 row">
            ...
            <div class="col-md-10">
              <input type="number" step="0.1" placeholder="Enter capacity" class="form-control py-2" name="capacity" value="{{$class->capacity}}"/>
            </div>
          </div>
          <div class="form-group mb-3 row">
            <label for="" class="form-label col-md-2 fw-bold text-md-end">time From:</label>
            <div class="col-md-10">
              <input type="time" placeholder="" class="form-control py-2" name="timeFrom" value="{{$class->timeFrom}}"/>
            </div>
          </div>
          <div class="form-group mb-3 row">
            <label for="" class="form-label col-md-2 fw-bold text-md-end">time To:</label>
            <div class="col-md-10">
              <input type="time" placeholder="" class="form-control py-2" name="timeTo" value="{{$class->timeTo}}"/>
            </div>
          </div>
