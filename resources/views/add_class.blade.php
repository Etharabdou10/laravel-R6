      ...
      <div class="bg-light p-5 rounded">
        ...
        <form action="{{route('class.store')}}" method="POST" class="px-md-5">
          ...
          <div class="form-group mb-3 row">
            <label for="" class="form-label col-md-2 fw-bold text-md-end">Calss Name:</label>
            <div class="col-md-10">
              <input type="text" placeholder="Enter Calss Name" class="form-control py-2" name="class_name" />
            </div>
          </div>
          <div class="form-group mb-3 row">
          ...
          <div class="form-group mb-3 row">
            ...
            <div class="col-md-10">
              <input type="time" placeholder="" class="form-control py-2" name="timeFrom" />
            </div>
          </div>
          <div class="form-group mb-3 row">
            <label for="" class="form-label col-md-2 fw-bold text-md-end">time To:</label>
            <div class="col-md-10">
              <input type="time" placeholder="" class="form-control py-2" name="timeTo" />
            </div>
          </div>
          <div class="form-group mb-3 row">
